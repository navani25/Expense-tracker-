...
const EmptyState: React.FC<{ onAdd: () => void }> = ({ onAdd }) => (
    <div className="text-center p-8 my-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm animate-fade-in-up">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-2">Organize Your Spending</h2>
        <p className="text-gray-500 dark:text-gray-400 max-w-xs mx-auto mb-6">
            Create custom categories to get a better overview of where your money goes.
        </p>
        <button
            onClick={onAdd}
...
const ExpenseCategories: React.FC<ExpenseCategoriesProps> = ({ setActivePage, categories, onAddCategory, onDeleteCategory }) => {
